...
import MapGUI from './gui/MapGUI';
import TerrainGUI from './gui/TerrainGUI';
import HomeGUI from './gui/HomeGUI';
    ...
    return (
      <Router>
        <div id="TOOLBAR" style={this.style.toolbar}>
          ...
          <div id="DATGUI">
            <Route path="/" exact render={(props) => (<MapGUI data={this.state.maps} {...props} />)} />
            <Route path="/maps/" render={(props) => (<MapGUI data={this.state.maps} {...props} />)} />
            <Route path="/terrain/" render={(props) => (<TerrainGUI data={this.state.terrain} {...props} />)} />
          </div>
