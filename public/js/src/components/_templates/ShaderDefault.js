...
class ShaderName extends React.Component {
    static defaultProps = {
        clear: false,
        enabled: true,
        ...
        return (
            <ExpansionPanel defaultExpanded={this.props.expanded}>
                <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                    <Typography variant="h5" className={classes.heading}>ShaderName</Typography>
...
export default withStyles(styles)(ShaderName);
