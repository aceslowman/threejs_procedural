    ...
    return (
      <div className="subnavigation">
        ...
        <Paper
          ...
          square={true}
        >
          <Route path="/camera/" exact render={(props)=><PerspectiveCameraTools {...this.props} camera={this.props.cameras["Perspective"]} />}/> 
          <Route path="/camera/firstperson/" render={(props)=><FirstPersonCameraTools {...this.props} camera={this.props.cameras["First Person"]} />}/>
          <Route path="/camera/ortho/" render={(props)=><OrthographicCameraTools {...this.props} camera={this.props.cameras["Orthographic"]} />}/>
          <Route path="/camera/perspective/" render={(props)=><PerspectiveCameraTools {...this.props} camera={this.props.cameras["Perspective"]} />}/>
        </Paper>
      </div>
    );
  }
